...
# * Filename      field_0x220000E_0000.py
...
########################################################################################
def entry_0x220000E(infile, field, offset, len, version, mode, outfile):

        ########check parameter start#############
        if not field == '0x220000E':
            #print 'hidis field is ', field
            #print 'current field is', '0x220000E'
