...
# * Filename
# * Description   analysis taskswitch dump
# * Version       1.0
# * Data          2019.6.28
# * 
#***********************************************************************
...
def entry_0x4000021(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x4000021':
                print('hidis field is ', field)
                print('current field is', 'field_0x4000021')
            ...
            print("got entry field_0x4000021")
