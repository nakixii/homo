...
def analysis_gunas_mntn_log_MsCfgInfo_info( instream, outstream):
        outstream.writelines(["CustomCfgInfo_PlatformRatCap_RatNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        ...
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_WifiImsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_LteImsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_UtranImsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_GsmImsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_WifiEmsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_LteEmsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_RoamingImsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_ImsSupport:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_NrImsSupport:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ImsRatSupport_NrEmsSupport:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_VoiceDomain:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_WaitImsVoiceAvailTimerLen:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ClImsSupportFlg:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_ImsCfgInfo_ClVolteMode:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_ReAcqLteOnHrpdSyncIndFlag:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_Is1XLocInfoPrefThanLte:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_AvailableTimerLengthFirstSearch:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_AvailableTimerCountFirstSearch:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_AvailableTimerLengthDeepSearch:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_ScanTimerLen:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_SleepTimerLen:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_CLSysAcqWaitHsdCnfTimerLen:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_CLCLOosTimerMaxExpiredTimes:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_BsrCtrlDoEnterIdleRstLen:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_BsrTimerCtrl_BsrTimerActivateFlag:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_BsrTimerCtrl_BsrPhaseNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_BsrTimerCtrl_HrpdConnBsrActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_BsrTimerCtrl_EhrpdConnBsrActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        ulLooper        = 0
        while ulLooper < 2:
            ...
            ulLooper = ulLooper + 1         
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssSysAcqCfg_SysAcqTimerCfg_BsrTimerCtrl_HistoryActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_IsLocInfoUsedInSwitchOn:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_SysAcqMode:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_Cdma1XActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_LteActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_1xLocationInfo_Mcc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_1xLocationInfo_Mnc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_1xLocationInfo_Sid:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_1xLocationInfo_Nid:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_1xLocationInfo_1xPrioClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_1xLocationInfo_AIPrioClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_LteLocationInfo_Mcc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_LteLocationInfo_Mnc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_LteLocationInfo_PrioClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_ClSysAcqCtrlInfo_1xBsrLteActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_ClSysAcqCtrlInfo_1xBsrLteTimerFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_ClSysAcqCtrlInfo_Srlte1xBsrLteEnableFlag:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseOnePatternCfg_TotalTimeLen:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseOnePatternCfg_SleepTimeLen:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseOnePatternCfg_LteHistorySrchNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseOnePatternCfg_LteFullBandSrchNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseOnePatternCfg_LtePrefBandSrchNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseTwoPatternCfg_TotalTimeLen:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseTwoPatternCfg_SleepTimeLen:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseTwoPatternCfg_LteHistorySrchNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseTwoPatternCfg_LteFullBandSrchNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_1xSrcClSysAcqStrategy_PhaseTwoPatternCfg_LtePrefBandSrchNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        
        outstream.writelines(["CustomCfgInfo_ClSysAcqDsdsStrategy_ReAcqLteWithNoRfEnable:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ClSysAcqDsdsStrategy_ReAcqLteWithNoRfScene:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["CustomCfgInfo_ClSysAcqDsdsStrategy_ReAcqLteWithNoRfDelayTime:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        
        outstream.writelines(["CustomCfgInfo_TestConfig_NoCardModeCfgFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["CustomCfgInfo_ClSysAcqTypeCtrlCfg_HistoryActFlg:0x"])
        analysis_array_data_one_byte(instream, outstream, 40)
        outstream.writelines(["CustomCfgInfo_ClSysAcqTypeCtrlCfg_PrefBandActFlg:0x"])
        analysis_array_data_one_byte(instream, outstream, 40)
        
        outstream.writelines(["CustomCfgInfo_CdmaModemInfo_CurrCdmaModemId:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["CustomCfgInfo_CdmaModemInfo_LastCdmaModemId:0x%X\n" % struct.unpack('H', instream.read(2))])
        
        outstream.writelines(["CustomCfgInfo_CdmaClSwitchOnOptCfg_IsCdmaSwitchOnAsyncReadCard:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["CustomCfgInfo_AiModemCfg_ActFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["CustomCfgInfo_MultiModeEmcCfg_MultiModeEmcSupportFlag:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["MsSysCfgInfo_RatPrio_RatNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["MsSysCfgInfo_RatPrio_RatPrio:0x"])
        analysis_array_data_one_byte(instream, outstream, 7)
        outstream.writelines(["MsSysCfgInfo_CdmaVolteRecovRatPrio_RatNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["MsSysCfgInfo_CdmaVolteRecovRatPrio_RatPrio:0x"])
        analysis_array_data_one_byte(instream, outstream, 7)
        outstream.writelines(["MsSysCfgInfo_RoamCapability:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["MsSysCfgInfo_LteCapChangeFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["MsSysCfgInfo_LteCapSta:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_DisableReason:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_Band_WcdmaBand:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_Band_GsmBand:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_Band_LteBand:"])
        analysis_array_data_four_byte(instream, outstream, 8)
        outstream.writelines(["MsSysCfgInfo_Band_CdmaBand:0x%X\n" % struct.unpack('I', instream.read(4))])

def analysis_gunas_mntn_log_NwInfo_info( instream, outstream):
        outstream.writelines(["ucNrLteN26Ind:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["GuCapInfo_NwBsCap:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["LteCapInfo_NwBsCap:0x%X\n" % struct.unpack('B', instream.read(1))])
        ...
        outstream.writelines(["SysInfo_3GppSysInfo_LmmAccessType:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["SysInfo_3GppSysInfo_PrioClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["SysInfo_3GppSysInfo_CellId:0x%X\n" % struct.unpack('I', instream.read(4))])
        ...
        outstream.writelines(["SysInfo_3Gpp2SysInfo_1xSysInfo_1xSysSrvInfo_1xPriClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["SysInfo_3Gpp2SysInfo_1xSysInfo_1xSysSrvInfo_AIPriClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        ...
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["SysInfo_3Gpp2SysInfo_1xSysInfo_1xSysSrvInfo_ServiceInfo_ImsiI1_I2:0x%X\n" % struct.unpack('H', instream.read(2))])
        ...
        outstream.writelines(["LastSysInfo_LastCampOnLTEOrDoRat:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
...
def analysis_gunas_mntn_log_SysAcqCtrl_info( instream, outstream):
        outstream.writelines(["NoCardInitSearchLoc_InitSearchGulLoc_Plmn_Mcc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchGulLoc_Plmn_Mnc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchGulLoc_Lac:0x%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchGulLoc_Rat:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchCdmaLoc_Sid:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchCdmaLoc_Nid:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchCdmaLoc_Mcc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["NoCardInitSearchLoc_InitSearchWaitType:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["NoCardInitSearchLoc_IsLocInfoUsed:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["AllowSrchLteFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["LteSysPriClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        ...
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["LteOos1xActDelayTimer:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["EpsAttachAllow:0x%X\n" % struct.unpack('I', instream.read(4))])
        ...
        outstream.writelines(["ClEnhanceVoltePingPongStrategy_DisableLteTimerLen:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["ClEnhanceVoltePingPongStrategy_SwitchCtrlTimerLen:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["ClEnhanceVoltePingPongStrategy_MaxPingPongNum:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["ClNormalVoltePingPongInfo_CurrSwitchNum:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["ClNormalVoltePingPongInfo_SwitchBeginSlice:"])
        analysis_array_data_four_byte(instream, outstream, 10)
        outstream.writelines(["ClNormalVoltePingPongInfo_LteStatus:0x%X\n" % struct.unpack('I', instream.read(4))])
...
def entry_0x220000A(infile, field, offset, len, version, mode, outfile):     
        ...
        elif not version == '0x0006':
            print ("hidis version is %s" % (version))
            print ("current version is 0x0006")
