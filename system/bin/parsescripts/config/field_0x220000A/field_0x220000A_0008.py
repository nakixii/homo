...
def analysis_gunas_mntn_log_MsCfgInfo_info( instream, outstream):
        ...
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_NrWaitImsVoiceAvailTimerLen:0x%X\n" % struct.unpack('I', instream.read(4))])
        ...
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_3gppActiveFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        ...
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_3gppLocationInfo_Mcc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_3gppLocationInfo_Mnc:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["CustomCfgInfo_MmssNvimCfgInfo_MmssLastLocInfo_3gppLocationInfo_PrioClass:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        ...
        outstream.writelines(["MsSysCfgInfo_NrRatChangeFlg:0x%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:0x%X\n" % ucReserve])
        outstream.writelines(["MsSysCfgInfo_LteCapSta:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_DisableLReason:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_NrCapSta:0x%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["MsSysCfgInfo_DisableNrReason:0x%X\n" % struct.unpack('I', instream.read(4))])
        ...
        outstream.writelines(["MsSysCfgInfo_Band_NrBand:"])
...
def entry_0x220000A(infile, field, offset, len, version, mode, outfile):     
        ...
        elif not version == '0x0008':
            print ("hidis version is %s" % (version))
            print ("current version is 0x0008")
