...
# * Filename
# * Description   analysis fiqinfo dump
# * Version       1.0
# * Data          2019.6.28
#***********************************************************************
import struct
...
def entry_0x8000096(infile, field, offset, length, version, mode, outfile):
        try:
            if not field == '0x8000096':
                print('hidis field is ', field)
                print('current field is', '0x2000096')
