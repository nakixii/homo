...
def entry_0x2300001(infile, field, offset, len, version, mode, outfile):

    if not field == '0x2300001':
        print 'hidis field is ', field
        print 'current field is', '0x2300001'
...
entry_0x7200013(filein, "0x2300001", '0x262a0c', '0x2800', 0, 0, fileout)
filein.close()
fileout.close();
'''
