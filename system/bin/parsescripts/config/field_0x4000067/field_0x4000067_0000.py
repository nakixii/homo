...
# * Filename
# * Description   analysis pdsysctrl dump
# * Version       1.0
# * Data          2019.6.28
# * 
#***********************************************************************
...
def PrintSysctrlInfo(infile, field, offset, length, version, mode, outfile):
        ...
        print("got entry 0x4000067 PrintSysctrlInfo, length is 0x%x" %(int(length,16)))
...
def entry_0x4000067(infile, field, offset, length, version, mode, outfile):
    if not field == '0x4000067':
        print('hidis field is ', field)
        print('current field is', '0x4000067')
    ...
    print("got entry 0x4000067")
    PrintSysctrlInfo(infile, field, offset, length, version, mode, outfile)
    return 0
    
if __name__ == '__main__':
    entry_0x4000067(infile, field, offset, length, version, mode, outfile)
