...
def PrintRegs(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x4000029 PrintRegs")
...
def entry_0x4000029(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x4000029':
                print('hidis field is ', field)
                print('current field is', '0x4000029')
