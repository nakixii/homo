...
def entry_0x8000098(infile, field, offset, length, version, mode, outfile):
    try:
        outfile.write(('[MDM L2HAC EICC INFO PARSE]\r\n'))
        ...
        outfile.write(
            ('[MDM L2HAC EICC INFO PARSE COMPLETED]\r\n'))
        return 0
        ...
        outfile.write(
            ('[MDM L2HAC EICC INFO PARSE FAILED]\r\n'))
        return 0
