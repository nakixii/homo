...
g_StampEnumTable = {
        ...
        15:("NRCPM_HWPOWERDOWN_0",          "Enter sleep proc,read sleep flag,stop dsp core"),
        16:("NRCPM_HWPOWERDOWN_1",          "check waiti,wake_lock flag"),
        17:("NRCPM_HWPOWERDOWN_2",          "Callback suspend early"),
        18:("NRCPM_HWPOWERDOWN_3",          "store dsp image ok"),
        19:("NRCPM_HWPOWERDOWN_4",          "dsp tcm retention"),
        20:("NRCPM_HWPOWERDOWN_5",          "dsp core power down"),
        21:("NRCPM_HWPOWERDOWN_6",          "dsp noc idle enable,ll1c pd clk disable"),
        22:("NRCPM_HWPOWERDOWN_7",          "dsp sleep_flag is invaild"),
        23:("NRCPM_HWPOWERDOWN_8",          "Dsp pll disable"),
        24:("NRCPM_HWPOWERDOWN_9",          "Callback suspend"),
        25:("NRCPM_HWPOWERDOWN_10",         "write sleep flag"),
        26:("NRCPM_HWPOWERDOWN_11",         "ccpu core wake unlock"),
        27:("NRCPM_HWPOWERDOWN_12",         "Finish sleep proc"),
        28:("NRCPM_HALT_NEED_NOT_DEAL_0",   "has wake lock flag is ture,don't allow Dsp sleep"),
        29:("NRCPM_HALT_NEED_NOT_DEAL_1",   "eicc pipe is not empty,don't allow Dsp sleep"),
        ...
        35:("NRCPM_HWPOWERUP_1",            "Dsp_pll enable"),
        36:("NRCPM_HWPOWERUP_2",            "read sleep type"),
        37:("NRCPM_HWPOWERUP_3",            "ll1c pd clk enalbe"),
        38:("NRCPM_HWPOWERUP_4",            "dsp power on"),
        39:("NRCPM_HWPOWERUP_5",            "write dsp extern boot flag"),
        40:("NRCPM_HWPOWERUP_6",            "......"),
        41:("NRCPM_HWPOWERUP_7",            "......"),
        42:("NRCPM_HWPOWERUP_8",            "......"),
        43:("NRCPM_HWPOWERUP_9",            "......"),
        44:("NRCPM_HWPOWERUP_10",           "Callback resume,dsp core run"),
        45:("NRCPM_HWPOWERUP_11",           "Finish awake proc"),
        ...
        52:("NRCPM_RESUME_4",               "allow dsp sleep"),
...
def ExpaseMspSleep(infile, field, offset, len, version, mode, outfile):
        ...
        return ret
########################################################################################
def entry_0x700009A(infile, field, offset, len, version, mode, outfile):
        ########check parameter start#############
        if not field == '0x700009A':
            print('hidis field is ', field)
            print('current field is', '0x700009A')
