...
def entry_0x8000001(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x8000001':
                print('hidis field is ', field)
                print('current field is', '0x8000001')
            ...
            print("got entry 0x8000001")
            outfile.writelines("==HAC TASKSWITCH==\n")
