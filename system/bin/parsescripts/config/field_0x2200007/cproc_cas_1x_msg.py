...
description     :   list cas cproc 1x msg
modify  record  :   2016-03-10 create file
                            2016-11-09 update 
"""

cas_cproc_1x_msg_enum_table_0000 = {
    0x2000 :     "ID_CAS_CPROC_LONG_CODE_CFG_REQ",                                                      
    ...
    0x2072 :     "ID_CAS_CPROC_1X_VE_MODE_IND",
    0x2073 :     "ID_CAS_CPROC_1X_IDLE_FER_REQ",
    0x2074 :     "ID_CAS_CPROC_1X_SCH_STOP_IND",
    0x2075 :     "ID_CAS_CPROC_1X_DISABLE_RTCH_IND",
    0x2076 :     "ID_CAS_CPROC_1X_SLEEP_IND",
    0x2077 :     "ID_CAS_CPROC_1X_WAKEUP_IND",
}

cas_cproc_1x_msg_enum_table_0100 = {
    0x2000 :     "ID_CAS_CPROC_LONG_CODE_CFG_REQ",                                                      
    0x2001 :     "ID_CPROC_CAS_1X_LONG_CODE_CFG_CNF",                                                   
    0x2002 :     "ID_CAS_CPROC_1X_REL_ALL_REQ",                                                         
    0x2003 :     "ID_CPROC_CAS_1X_REL_ALL_CNF",                                                         
...
cas_cproc_1x_msg_enum_table_0101 = {
    0x2000 :     "ID_CAS_CPROC_LONG_CODE_CFG_REQ",                                                      
    0x2001 :     "ID_CPROC_CAS_1X_LONG_CODE_CFG_CNF",                                                   
    0x2002 :     "ID_CAS_CPROC_1X_REL_ALL_REQ",                                                         
    0x2003 :     "ID_CPROC_CAS_1X_REL_ALL_CNF",                                                         
    ...
    0x207C :     "ID_CPROC_CAS_1X_SLOT_MODE_IND",
    0x2100 :     "ID_CAS_CPROC_1X_IDLEACCESS_MEAS_REQ",                                   
    0x2101 :     "ID_CPROC_CAS_1X_IDLEACCESS_MEAS_CNF",                                   
    0x2102 :     "ID_CPROC_CAS_1X_IDLEACCESS_MEAS_IND",                                   
    0x2103 :     "ID_CAS_CPROC_1X_TCH_MEAS_REQ",                                          
...
def get_cas_cproc_1x_msg_str(MsgId, usVersion):
    if (usVersion == 0x0000):
        for MsgIdIndex in cas_cproc_1x_msg_enum_table_0000.keys():
            if MsgIdIndex == MsgId:
                return cas_cproc_1x_msg_enum_table_0000[MsgIdIndex]
        return "unknown"
    elif (usVersion == 0x0100 or usVersion == 0x0103):
        for MsgIdIndex in cas_cproc_1x_msg_enum_table_0100.keys():
            if MsgIdIndex == MsgId:
                return cas_cproc_1x_msg_enum_table_0100[MsgIdIndex]
        return "unknown"
    elif (usVersion == 0x0101):
        for MsgIdIndex in cas_cproc_1x_msg_enum_table_0101.keys():
            if MsgIdIndex == MsgId:
                return cas_cproc_1x_msg_enum_table_0101[MsgIdIndex]
        return "unknown"
