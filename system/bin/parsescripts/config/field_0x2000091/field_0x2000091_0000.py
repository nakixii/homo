...
def PrintExcInfo(infile, field, offset, length, version, mode, outfile):
...
def entry_0x2000091(infile, field, offset, length, version, mode, outfile):
        try:
            if not field == '0x2000091':
                print('hidis field is ', field)
                print('current field is', '0x2000091')
            ...
            PrintExcInfo(infile, field, offset, length, version, mode, outfile)
            return 0
