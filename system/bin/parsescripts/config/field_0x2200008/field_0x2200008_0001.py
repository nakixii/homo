...
def cas_get_msgstrbymsgid_test( Sendpid, Rcvpid, usMsgId, outstream):
...
def cas_get_msgstrbymsgid_test( pid1, pid2, usMsgId, outstream):
...
def analysis_cas_1x_mntn_per_handled_msg_info( instream, fileLocalOffset, outstream):
        ...
        strMsgId        = cas_get_msgstrbymsgid_test( strSendPid, strRcvPid, usMsgId, outstream)
...
def entry_0x2200008(infile, field, offset, len, version, mode, outfile):
        ...
        #save2file = open("c:/modem_dump_cas.txt", 'w')
