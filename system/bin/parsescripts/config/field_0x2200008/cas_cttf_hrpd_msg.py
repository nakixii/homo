...
cas_cttf_hrpd_msg_enum_table = {
    ...
    0x340D :     "ID_CAS_CTTF_HRPD_SNP_CLEAR_TX_AC_CHAN_DATA_REQ",
    0x340E :     "ID_CTTF_CAS_HRPD_SNP_CLEAR_TX_AC_CHAN_DATA_CNF",	
    ...
    0x0002 :     "ID_PS_RRM_RADIO_RESOURCE_APPLY_CNF",	
...
def get_cas_cttf_hrpd_msg_str( MsgId):
    for MsgIdIndex in cas_cttf_hrpd_msg_enum_table.keys():
        if MsgIdIndex == MsgId:
            return cas_cttf_hrpd_msg_enum_table[MsgIdIndex]
