...
# * Filename      field_0x7000093_0000.py
# * Description   analysis wdt dump
#***********************************************************************
import struct
import os
import sys
...
def PrintWdtData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x7000093 PrintWdtData")
...
def entry_0x7000093(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0x7000093':
                print('hidis field is ', field)
                print('current field is', '0x7000093')
                return error['ERR_CHECK_FIELD']
            elif not version == '0x0000':
                print('hidis version is ', version)
                print('current version is ', '0x0000')
                return error['ERR_CHECK_VERSION']
            print("got entry 0x7000093")
