...
def PrintSysctrlInfo(infile, field, offset, length, version, mode, outfile):
        ...
        print("got entry 0x4000068 PrintSysctrlInfo, length is 0x%x" %(int(length,16)))
...
def entry_0x4000068(infile, field, offset, length, version, mode, outfile):
    if not field == '0x4000068':
        print('hidis field is ', field)
        print('current field is', '0x4000068')
