...
def PrintNocData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x7000084 PrintNocData")
...
def entry_0x7000084(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0x7000084':
                print('hidis field is ', field)
                print('current field is', '0x7000084')
