...
def ExpaseMemDebug(infile, field, offset, len, version, mode, outfile):
        ...
        print("got entry 0x2000007C PrintMemdebug")
        ...
        return
def entry_0x200007C(infile, field, offset, len, version, mode, outfile):
########check parameter start#############
    if not field == '0x200007C':
        print('hidis field is ', field)
        print('current field is', '0x2000007C')
