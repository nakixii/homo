...
def PrintEDMAData(infile, field, offset, slen, version, mode, outfile):
		...
		print("got entry 0x7000085 PrintEDMAData")
...
########################################################################################
def entry_0x7000085(infile, field, offset, len, version, mode, outfile):
		########check parameter start#############
		if not field == '0x7000085':
			print('hidis field is ', field)
			print('current field is', '0x7000085')
