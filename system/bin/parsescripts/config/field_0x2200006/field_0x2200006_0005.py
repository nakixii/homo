...
def analysis_gunas_mntn_log_MsCapability_info_version0x02( instream, outstream): 
        ...
        strMsNotifyNwCapInfo_NotifyNwEndcCap     = '%X'% MsNotifyNwCapInfo_NotifyNwEndcCap
...
def analysis_gunas_mntn_log_MsSysCfgInfo_info_version0x02( instream, outstream):
        ...
        outstream.writelines(["DisableNrStaInfo_NrCapabilityStatus:%X\n" % struct.unpack('I', instream.read(4))])
        outstream.writelines(["DisableNrStaInfo_DisableNrReason:%X\n" % struct.unpack('I', instream.read(4))])
...
def analysis_gunas_mntn_log_PsDomainInfo_info_version0x02( instream, outstream):
        ...
        outstream.writelines(["GprsSupportChgFlg:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["PsHandoverTimerStatus:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        ...
        outstream.writelines(["NrRegInfo_LastNrRegTai_PlmnId_0:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_LastNrRegTai_PlmnId_1:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_LastNrRegTai_PlmnId_2:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        
        outstream.writelines(["NrRegInfo_LastNrRegTai_Tac_Tac:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_LastNrRegTai_Tac_TacCont:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_LastNrRegTai_Tac_TacCont1:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])

        outstream.writelines(["NrRegInfo_NrGutiInfo_ValidFlag:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_PlmnId_0:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_PlmnId_1:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_PlmnId_2:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_AmfSetId:%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_AmfRegionId:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_AmfPointer:%X\n" % struct.unpack('B', instream.read(1))])
        outstream.writelines(["NrRegInfo_NrGutiInfo_Guti_Tmsi:%X\n" % struct.unpack('I', instream.read(4))])

        outstream.writelines(["NrRegInfo_NrRegState:%X\n" % struct.unpack('B', instream.read(1))])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
...
def analysis_gunas_mntn_log_OriginalRejCause_info_version0x02( instream, outstream):
        ...
        (ucReserve,)           = struct.unpack('B', instream.read(1))
        outstream.writelines(["ucReserve:%X\n" % ucReserve])
        outstream.writelines(["usPsOriginalRejectCause:%X\n" % struct.unpack('H', instream.read(2))])
        outstream.writelines(["usCsOriginalRejectCause:%X\n" % struct.unpack('H', instream.read(2))])
