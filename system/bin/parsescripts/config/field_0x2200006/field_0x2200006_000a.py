...
def analysis_gunas_mntn_log_CampPlmnInfo_info_version0x02( instream, outstream):
    ...
    outstream.writelines(["tempCampStat:0x%X\n" % struct.unpack('B', instream.read(1))])
    outstream.writelines(["campCnType:0x%X\n" % struct.unpack('B', instream.read(1))])
    outstream.writelines(["sptCnType:0x%X\n" % struct.unpack('B', instream.read(1))])
    ...
    outstream.writelines(["Lai_Camp_CnType:0x%X\n" % struct.unpack('B', instream.read(1))])
    ...
    outstream.writelines(["OldLai_Camp_CnType:0x%X\n" % struct.unpack('B', instream.read(1))])
...
def analysis_gunas_mntn_log_CsDomainInfo_info_version0x02( instream, outstream):
    ...
    outstream.writelines(["LastSuccLai_CampCnType:0x%X\n" % struct.unpack('B', instream.read(1))])
    ...
    outstream.writelines(["LaiInfoInAcceptMsg_CampCnType:0x%X\n" % struct.unpack('B', instream.read(1))])
    ...
    outstream.writelines(["lastLteSuccLai_CampCnType:0x%X\n" % struct.unpack('B', instream.read(1))])
...
def analysis_gunas_mntn_log_PsDomainInfo_info_version0x02( instream, outstream):
    ...
    outstream.writelines(["LastSuccRai_Lai_CampCnType:0x%X\n" % struct.unpack('B', instream.read(1))])
    ...
    outstream.writelines(["raiInfoInAcceptMsg_lai_CampCntype:0x%X\n" % struct.unpack('B', instream.read(1))])
...
def entry_0x2200006(infile, field, offset, len, version, mode, outfile):
    ...
    elif not version == '0x000a':
        print ("hidis version is %s" % (version))
        print ("current version is 0x000a")
