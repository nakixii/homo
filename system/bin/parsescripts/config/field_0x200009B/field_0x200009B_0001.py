...
def entry_0x200009B(infile, field, offset, length, version, mode, outfile):
    try:
        outfile.write(('[MDM LR EICC INFO PARSE]\r\n'))
        ...
        outfile.write(
            ('[MDM LR EICC INFO PARSE COMPLETED]\r\n'))
        return 0
