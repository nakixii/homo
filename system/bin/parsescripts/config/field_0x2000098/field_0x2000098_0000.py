...
def PrintBBPData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x2000098 PrintBBPData")
...
def entry_0x2000098(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0x2000098':
                print('hidis field is ', field)
                print('current field is', '0x2000098')
