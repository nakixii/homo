...
def PrintPcdevInfo(infile, field, offset, slen, version, mode, outfile):
		...
		print("got entry 0xC100014 PrintPcdevInfo")
...
def entry_0xC100014(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0xC100014':
                print('hidis field is ', field)
                print('current field is', '0xC100014')
