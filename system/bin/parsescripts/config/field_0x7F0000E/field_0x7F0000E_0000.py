...
def PrintTaskTcb(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0x7F0000E PrintTaskTcb")
...
def entry_0x7F0000E(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x7F0000E':
                print('hidis field is ', field)
                print('current field is', '0x7F0000E')
            ...
            print("got entry 0x7F0000E")
            outfile.writelines("==NR ALLTASK_TCB==\n")
