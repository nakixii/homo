...
def PrintUserData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0xC0F000B PrintUserData")
...
def entry_0xC0F000B(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0xC0F000B':
                print('hidis field is ', field)
                print('current field is', '0xC0F000B')
