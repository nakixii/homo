...
# * Filename
# * Description   analysis m3baseinfo dump
# * Version       1.0
# * Data          2019.6.28
# * 
#***********************************************************************
...
def entry_0x4100001(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x4100001':
                print('hidis field is ', field)
                print('current field is', '0x4100001')
