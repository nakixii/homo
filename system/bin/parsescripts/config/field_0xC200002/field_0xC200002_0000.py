...
def PrintOAMData(infile, field, offset, slen, version, mode, outfile):
        ...
        print("got entry 0xC200002 PrintOAMData")
...
def entry_0xC200002(infile, field, offset, slen, version, mode, outfile, field_list = None):
        try:
            if not field == '0xC200002':
                print('hidis field is ', field)
                print('current field is', '0xC200002')
