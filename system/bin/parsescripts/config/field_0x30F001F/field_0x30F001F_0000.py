...
def entry_0x30F001F(infile, field, offset, slen, version, mode, outfile):
        try:
            if not field == '0x30F001F':
                print('hidis field is ', field)
                print('current field is', '0x30F001F')
